...
<head>
    ...
    <!-- Hotjar Tracking Code for https://bregaster.com -->
    <script>
        (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:3583998,hjsv:6};
...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div style="margin:20px" class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="319.5" height="90.3"
                    ...
                    <g transform="translate(0.000000,301.000000) scale(0.100000,-0.100000)" stroke="none">
            ...
            <div style="margin:20px" class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            <div style="margin:20px" class="flex justify-center mt-4 sm:items-center sm:justify-between">
